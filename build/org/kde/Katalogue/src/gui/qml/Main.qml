...
Kirigami.ApplicationWindow {
    ...
    property int searchPageSize: 200
    ...
    Shortcut {
        sequence: "Ctrl+S"
        onActivated: scanDialog.open()
    }
    Shortcut {
        sequence: "Ctrl+O"
        onActivated: openCatalogDialog.open()
    }
    Shortcut {
        sequence: "Escape"
        onActivated: {
                                            ...
                                            Column {
                                                ...
                                                Kirigami.Card {
                                                    ...
                                                    contentItem: Column {
                                                        ...
                                                        Button {
                                                            visible: KatalogueClient.searchResults.length > 0 &&
                                                                     KatalogueClient.searchResults.length >= root.searchPageSize
                                                            text: qsTr("Load more results")
                                                            anchors.horizontalCenter: parent.horizontalCenter
                                                            onClicked: {
                                                                root.searchOffset += root.searchPageSize
                                                                performSearch()
                                                            }
                                                        }
    ...
    function performSearch() {
        ...
        KatalogueClient.search(query, volumeId, fileType, root.searchPageSize, root.searchOffset)
    }
